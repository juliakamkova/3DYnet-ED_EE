...
class YNet_Attention_3D(pl.LightningModule):
    ...
    def __init__(self, n_class=3):
        ...
        self.convBlock_4_0 = ConvBlock(3 * CHANNELS[4], CHANNELS[4])
...
#
# data = torch.randn((1, 1, 96, 96, 32)).to(device)  # the input has to be 96
# label = torch.randint(0, 2, (1, 1, 96, 96, 32)).to(device)
# net = YNet_noskip()
# # net.eval()
# net = net.to(device)
# net.apply(init)
