...
class ResYNetED3D(nn.Module):
    ...
    def forward(self, x):
        ...
        #print('down3_0', down3_0.shape)
        #print('down2_0', down2_0.shape)
        #print('down1_0', down1_0.shape)
        #print('down0_0', down0_0.shape)

        # #print('down4_1', down4_1.shape)
...
#     wandb.init(project='3DYNet-ResNet', name='training_run_1 (3DResYNETED)')
#
#     # Pseudo data
